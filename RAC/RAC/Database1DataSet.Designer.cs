...
namespace RAC {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public usersRow AddusersRow(string username, string role, string name) {
...
namespace RAC.Database1DataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `users` WHERE ((`ID` = ?) AND ((? = 1 AND `username` IS NULL) OR (`us" +
                "ername` = ?)) AND ((? = 1 AND `role` IS NULL) OR (`role` = ?)) AND ((? = 1 AND `" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `users` (`username`, `role`, `name`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `users` SET `username` = ?, `role` = ?, `name` = ? WHERE ((`ID` = ?) AND (" +
                "(? = 1 AND `username` IS NULL) OR (`username` = ?)) AND ((? = 1 AND `role` IS NU" +
                "LL) OR (`role` = ?)) AND ((? = 1 AND `name` IS NULL) OR (`name` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RAC.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, username, role, name FROM users";
        ...
        public virtual int Delete(int Original_ID, string Original_username, string Original_role, string Original_name) {
        ...
        public virtual int Insert(string username, string role, string name) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string role, string name, int Original_ID, string Original_username, string Original_role, string Original_name) {
            if ((username == null)) {
